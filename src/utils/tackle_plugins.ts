...
import { PluginStage, PluginHandler, HandlerFactory, HandlerFactoryRet, OmniPlugin } from '../index.d';

export function getHandlers (plugins: OmniPlugin[], stage: PluginStage) {
  const handlers: { [pluginName: string]: HandlerFactoryRet } = {};
